  ...
  return (
    <button className='rounded-md text-left outline-none bg-slate-800 p-5 space-y-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
      ...
      <p className='text-sm leading-6 text-slate-400'>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum mollitia a perspiciatis ullam velit necessitatibus dolorum deleniti nisi. Nemo voluptate inventore fugit aspernatur nisi vitae incidunt quam voluptates repellendus maxime.
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum mollitia a perspiciatis ullam velit necessitatibus dolorum deleniti nisi. Nemo voluptate inventore fugit aspernatur nisi vitae incidunt quam voluptates repellendus maxime.
      </p>
